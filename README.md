...
To find all `<letter-small>` elements in Job and write them to a file,
run `py-examples/main_letter_small_job.py` from the repo root, or use
it as a starting point for your own script. Its full source
(generated from the MAM-basics pipeline) is:

<!-- BEGIN_GENERATED: main_letter_small_job.py -->
```python
...
```
<!-- END_GENERATED: main_letter_small_job.py -->
